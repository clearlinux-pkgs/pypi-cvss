...
Source0  : https://files.pythonhosted.org/packages/f0/c1/3ec60fa39d598bf652871f012cf8fd7e85f80ca6b2243c312c84a96a1314/cvss-3.1.tar.gz
...
%prep
%setup -q -n cvss-3.1
cd %{_builddir}/cvss-3.1
pushd ..
cp -a cvss-3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712587230
