...
Source0  : https://files.pythonhosted.org/packages/4d/cf/63414dab3f513a18a3d1183ac3131d0f731bdaeffc125edcd3c08c2f2104/cvss-3.4.tar.gz
...
%prep
%setup -q -n cvss-3.4
cd %{_builddir}/cvss-3.4
pushd ..
cp -a cvss-3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739373710
